      ...
      <div class="modal-body">
        ...
        <div class="mb-4 col-xl mb-md-0">
          ...
          <div class="card-body">
            ...
            <h3 class="mb-1 text-center card-title text-capitalize">{{ $plano->nome }}</h3>
            ...
            <div class="text-center h-px-100">
                <div class="d-flex justify-content-center">
                    ...
                    <h1 class="mb-0 display-4 text-primary price-monthly" data-monthly-price="{{ $plano->preco }}" data-yearly-price="{{ $plano->preco * 12 * 0.9 }}">
                ...
                <div class="mt-2 text-center">
                    <small class="text-muted">
                        R$<span class="price-yearly" data-yearly-price="{{ $plano->preco * 12 * 0.9 }}">
        ...
        data-id="{{ $plano->id }}" data-bs-dismiss="modal" disabled> Plano Atual</button>
        @endif
