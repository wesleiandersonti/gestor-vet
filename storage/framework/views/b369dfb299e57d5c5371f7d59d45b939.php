      ...
      <div class="card-body">
        ...
        <form action="<?php echo e(route('pages-profile-user-post')); ?>" method="POST" enctype="multipart/form-data">
          ...
          <div class="mb-3">
            ...
            <input type="text" class="form-control" oninput="mask(this, masktel)" maxlength="15" id="whatsapp" name="whatsapp" value="<?php echo e(Auth::user()->whatsapp); ?>" required>
          </div>
...
<!--/ User Profile Content -->
<?php $__env->stopSection(); ?>
<?php echo $__env->make('layouts/layoutMaster', \Illuminate\Support\Arr::except(get_defined_vars(), ['__data', '__path']))->render(); ?><?php /**PATH /home/u403845897/domains/gestor.spxtv.top/public_html/resources/views/content/pages/pages-profile-user.blade.php ENDPATH**/ ?>