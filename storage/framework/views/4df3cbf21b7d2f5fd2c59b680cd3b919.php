                ...
                <div class="dropdown">
                    ...
                    <div class="dropdown-menu">
                        ...
                        <button type="button" class="dropdown-item" 
                                ...
                                onclick="prepareConnectionModal(<?php echo e($conexao->id); ?>)">
...
document.addEventListener('DOMContentLoaded', function() {
    ...
    prepareConnectionModal(<?php echo e($conexao->id); ?>);
    
    // Verificar status da conexão periodicamente
    var checkInterval = setInterval(function() {
        fetch(`/conexoes/check-status/<?php echo e($conexao->id); ?>`)
            .then(response => response.json())
            .then(data => {
...
<?php endif; ?>
<?php $__env->stopSection(); ?>
<?php echo $__env->make('layouts/layoutMaster', \Illuminate\Support\Arr::except(get_defined_vars(), ['__data', '__path']))->render(); ?><?php /**PATH /home/u403845897/domains/gestor.spxtv.top/public_html/resources/views/content/apps/app-whatsapp.blade.php ENDPATH**/ ?>