...
<?php $__currentLoopData = $templates; $__env->addLoop($__currentLoopData); foreach($__currentLoopData as $template): $__env->incrementLoopIndices(); $loop = $__env->getLastLoop(); ?>
    ...
    <!-- Boas-vindas -->
    <optgroup label="Boas-vindas">
        <option value="novo_cliente" <?php echo e($template->finalidade == 'novo_cliente' ? 'selected' : ''); ?>>
    ...
    <!-- Clientes com Pagamento Atrasado -->
    <optgroup label="Clientes com Pagamento Atrasado">
        <option value="cobranca_1_dia_atras" <?php echo e($template->finalidade == 'cobranca_1_dia_atras' ? 'selected' : ''); ?>>Cliente venceu há 1 Dia</option>
        <option value="cobranca_2_dias_atras" <?php echo e($template->finalidade == 'cobranca_2_dias_atras' ? 'selected' : ''); ?>>Cliente venceu há 2 Dias</option>
        <option value="cobranca_3_dias_atras" <?php echo e($template->finalidade == 'cobranca_3_dias_atras' ? 'selected' : ''); ?>>Cliente venceu há 3 Dias</option>
        <option value="cobranca_5_dias_atras" <?php echo e($template->finalidade == 'cobranca_5_dias_atras' ? 'selected' : ''); ?>>Cliente venceu há 5 Dias</option>
        <option value="cobranca_7_dias_atras" <?php echo e($template->finalidade == 'cobranca_7_dias_atras' ? 'selected' : ''); ?>>Cliente venceu há 7 Dias</option>
    </optgroup>

    <!-- Clientes com Vencimento Hoje -->
    <optgroup label="Clientes com Vencimento Hoje">
        <option value="vencimento_hoje" <?php echo e($template->finalidade == 'vencimento_hoje' ? 'selected' : ''); ?>>Cliente vence hoje</option>
    </optgroup>

    <!-- Clientes com Vencimento Futuro -->
    <optgroup label="Clientes com Vencimento Futuro">
        <option value="cobranca_1_dia_futuro" <?php echo e($template->finalidade == 'cobranca_1_dia_futuro' ? 'selected' : ''); ?>>Cliente vencerá em 1 Dia</option>
        <option value="cobranca_2_dias_futuro" <?php echo e($template->finalidade == 'cobranca_2_dias_futuro' ? 'selected' : ''); ?>>Cliente vencerá em 2 Dias</option>
        <option value="cobranca_3_dias_futuro" <?php echo e($template->finalidade == 'cobranca_3_dias_futuro' ? 'selected' : ''); ?>>Cliente vencerá em 3 Dias</option>
        <option value="cobranca_5_dias_futuro" <?php echo e($template->finalidade == 'cobranca_5_dias_futuro' ? 'selected' : ''); ?>>Cliente vencerá em 5 Dias</option>
        <option value="cobranca_7_dias_futuro" <?php echo e($template->finalidade == 'cobranca_7_dias_futuro' ? 'selected' : ''); ?>>Cliente vencerá em 7 Dias</option>
    </optgroup>

    <!-- Outras Finalidades -->
    <optgroup label="Outras Finalidades">
        <option value="cobranca_manual" <?php echo e($template->finalidade == 'cobranca_manual' ? 'selected' : ''); ?>>Cobrança Manual</option>
        <option value="vencidos_generico" <?php echo e($template->finalidade == 'vencidos_generico' ? 'selected' : ''); ?>>Vencidos (genérico)</option>
        <option value="pagamentos" <?php echo e($template->finalidade == 'pagamentos' ? 'selected' : ''); ?>>Pagamentos</option>
        <option value="compras_creditos" <?php echo e($template->finalidade == 'compras_creditos' ? 'selected' : ''); ?>>Compras Créditos</option>
        <option value="dados_iptv" <?php echo e($template->finalidade == 'dados_iptv' ? 'selected' : ''); ?>>Dados IPTV</option>
    </optgroup>
</select>
                        </div>
                        <div class="mb-3">
                        ...
                        <div class="mb-3" id="imagem_container<?php echo e($template->id); ?>" style="<?php echo e($template->tipo_mensagem === 'texto_com_imagem' ? '' : 'display:none;'); ?>">
...
<?php $__env->stopSection(); ?>
<?php echo $__env->make('layouts/layoutMaster', \Illuminate\Support\Arr::except(get_defined_vars(), ['__data', '__path']))->render(); ?><?php /**PATH /home/u403845897/domains/gestor.spxtv.top/public_html/resources/views/templates/index.blade.php ENDPATH**/ ?>