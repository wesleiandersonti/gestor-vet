    ...
    <div id="landingHero" class="section-py landing-hero position-relative">
      <div class="container">
        ...
        <div class="d-flex align-items-center justify-content-center mb-4">
          <?php if($empresa && $empresa->company_logo_light): ?>
            <img src="<?php echo e(asset(ltrim($empresa->company_logo_light, '/'))); ?>" alt="Logo" height="40" class="me-2">
          <?php endif; ?>
...
">
  <?php echo e($empresa->company_name ?? 'AUTOMAÇÃO, CONTROLE E RESULTADO — TUDO EM UM SÓ PAINEL'); ?>
...
<a href="<?php echo e($canalLink); ?>" target="_blank"
   class="btn px-4 py-2"
   style="
     border-radius:999px;
     font-weight:600;
  ...
  <a href="<?php echo e($grupoLink); ?>" target="_blank"
     class="btn px-4 py-2"
     style="
...
<section id="landingPricing" class="section-py bg-body landing-pricing">
    <div class="container">
        ...
        <div class="row gy-4 pt-lg-3">
            ...
            <?php $__currentLoopData = $planos; $__env->addLoop($__currentLoopData); foreach($__currentLoopData as $index => $plano): $__env->incrementLoopIndices(); $loop = $__env->getLastLoop(); ?>
            <div class="col-xl-4 col-lg-6">
                <div class="card <?php echo e($index == 1 ? 'border border-primary shadow-lg' : ''); ?>">
                    <div class="card-header">
                        <div class="text-center">
                            <img src="<?php echo e(asset('assets/img/front-pages/icons/' . ($icones[$plano->nome] ?? 'paper-airplane.png'))); ?>" alt="ícone <?php echo e($plano->nome); ?>" class="mb-4 pb-2" />
                            <h4 class="mb-1"><?php echo e($plano->nome); ?></h4>
                            <div class="d-flex align-items-center justify-content-center">
                                <span class="price-monthly h1 text-primary fw-bold mb-0">R$<?php echo e(number_format($plano->preco, 2, ',', '.')); ?></span>
                                <span class="price-yearly h1 text-primary fw-bold mb-0 d-none">R$<?php echo e(number_format($plano->preco * 0.9, 2, ',', '.')); ?></span>
                                <sub class="h6 text-muted mb-0 ms-1">/mês</sub>
                            </div>
                            <div class="position-relative pt-2">
                                <div class="price-yearly text-muted price-yearly-toggle d-none">R$<?php echo e(number_format($plano->preco * 10.8, 2, ',', '.')); ?> / ano (10% de desconto)</div>
                            </div>
                        </div>
                    </div>
                    <div class="card-body">
                        <ul class="list-unstyled">
                            <?php if($plano->detalhes): ?>
                                <?php $__currentLoopData = explode("\n", $plano->detalhes); $__env->addLoop($__currentLoopData); foreach($__currentLoopData as $detalhe): $__env->incrementLoopIndices(); $loop = $__env->getLastLoop(); ?>
                                    <?php if(trim($detalhe) != ''): ?>
                                    <li>
                                        <h5>
                                            <span class="badge badge-center rounded-pill bg-label-primary p-0 me-2"><i class="ti ti-check ti-xs"></i></span>
                                            <?php echo e(trim($detalhe)); ?>
                            ...
                            <li>
                                <h5>
                                    <span class="badge badge-center rounded-pill bg-label-primary p-0 me-2"><i class="ti ti-check ti-xs"></i></span>
                                    <?php if($plano->limite > 0 && $plano->limite < 9999): ?>
                                        Até <?php echo e($plano->limite); ?> clientes
                                    <?php else: ?>
                                        Clientes ilimitados
                                    <?php endif; ?>
                                </h5>
                        ...
                        <div class="d-grid mt-4 pt-3">
                            <a href="<?php echo e(url('/auth/register-basic')); ?>" class="btn <?php echo e($index == 1 ? 'btn-primary' : 'btn-label-primary'); ?>"><?php echo e($plano->botao ?: 'Começar'); ?></a>
                        </div>
                    </div>
                </div>
            </div>
...
<?php $__env->stopSection(); ?>
<?php echo $__env->make('layouts/layoutMaster', \Illuminate\Support\Arr::except(get_defined_vars(), ['__data', '__path']))->render(); ?><?php /**PATH /home/u403845897/domains/gestor.spxtv.top/public_html/resources/views/content/front-pages/landing-page.blade.php ENDPATH**/ ?>